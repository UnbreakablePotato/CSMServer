...
type Champion struct {
	...
	RecommendedPerks        []int    `json:"RecommendedPerks"`
	RecommendedSpells       []int    `json:"RecommendedSpells"`       // example [1, 2]
	RecommendedAbilityOrder []string `json:"RecommendedAbilityOrder"` // example ["Q","W","E"]
	RecommendedStartItems   []int    `json:"RecommendedStartItems"`   // should consist of a list of start item ids
	RecommendedItems        []int    `json:"RecommendedItems"`        // should consist of a list of item ids
	BestMatchups            []int    `json:"BestMatchups"`            // should consist of a list of champions ids
	WorstMatchups           []int    `json:"WorstMatchups"`           // should consist of a list of champions ids
}

type Matchup struct {
	ChampionName      string
	EnemyChampionName string
	EnemyChampIcon    string
	Build             Champion
}
